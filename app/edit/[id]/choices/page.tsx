...
export default function ChoicesPage() {
  ...
  const { choices, setData } = useEditStore();
  ...
  const handleNext = async () => {//Promise.all จะรอให้ทุก async ใน map เสร็จแล้วรวมค่าที่ return ทั้งหมดเป็น array
    ...
    router.push(`/edit/${id}/public-edit`);
  };
    ...
    <div>
      ...
      <div className="container-create" style={{paddingBottom: '10px'}}>
              ...
              <div key={choice.id} className="choice-card">
                ...
                <div className="choice-header">
                  ...
                  <div>
                    ...
                    <button onClick={() => setEditId(choice.id)} style={{width: '30px', height: '30px', background:"#BC4126", borderRadius:"50%",display:"flex", alignItems:"center", justifyContent:"center",marginTop: '3px'}}>
                      <Pen size={"20px"}/>
                    </button>
                  </div>
        ...
        <div className="container-button-button">
            <button onClick={() => router.push(`/edit/${id}/cover`)} className="button-create">&lt;cover</button>
